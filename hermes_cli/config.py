        ...
        if isinstance(custom_list, list) and custom_list:
            ...
            for entry in custom_list:
                ...
                if old_key and old_key not in {"no-key", "no-key-required", ""}:
                    ...
                    # Legacy entries can reference their credential via
                    # key_env — carry the ref instead of dropping it.
                    new_entry["key_env"] = str(entry["key_env"]).strip()
