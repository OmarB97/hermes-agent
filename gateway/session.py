...
class SessionSource:
    ...
    # None => the gateway's active/default profile (namespace ``agent:main``,
    # byte-identical to legacy keys — see _session_key_namespace), so the fork's
    # default single-profile behavior is unchanged unless a profile is set.
