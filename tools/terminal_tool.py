...
def terminal_tool(
    ...
    try:
        ...
        # stable, thread-safe anchor.  Resolved ahead of both the gateway
        # lifecycle guard and the approval guard, because each of them needs the
        # same cwd the command will actually run in.
        ...
        # session_key is already resolved above the gateway lifecycle guard and
        # the approval guard, both of which need the command's run directory.
        if background:
