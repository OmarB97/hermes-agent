...
export const zh: Translations = {
  ...
  settings: {
    ...
    about: {
      ...
      rebuildNeeded: '源代码已更改 — 请重新构建以应用本地更改。',
      rebuildNow: '立即重新构建',
  ...
  sidebar: {
    ...
    archiveAllTitle: '归档全部会话',
    archiveAllAria: '归档所有未置顶会话',
    archiveAllDialogTitle: '归档全部会话',
    archiveAllDialogDesc: '从侧边栏归档未置顶会话。已置顶、当前会话和正在运行的会话会保持可见。',
    archiveAllConfirm: '全部归档',
    archiveAllCancel: '取消',
    archiveAllSubmitting: '正在归档...',
    archiveAllChecked: count => `将检查 ${count} 个可见会话。`,
    archiveAllNone: '没有可归档的会话。',
    cloudChannelsTitle: '云端频道',
    cloudChannelsDesc: '接受邀请并查看此云端账户可用的频道。',
    cloudInviteTokenAria: '云端邀请令牌',
    cloudInviteTokenPlaceholder: '邀请令牌',
    cloudInviteAccept: '接受',
    cloudInviteAccepting: '正在接受...',
    cloudChannelsListTitle: '可用频道',
    cloudChannelsLoading: '正在加载频道...',
    cloudChannelsEmpty: '还没有云端频道。',
    cloudChannelsRefresh: '刷新',
    cloudChannelsRefreshing: '正在刷新...',
    cloudChannelsClose: '关闭',
    cloudChannelsOwner: '所有者',
    cloudChannelsRead: '只读',
    cloudChannelsSeq: seq => `seq ${seq}`,
    cloudMessagesTitle: '云端历史',
    cloudMessagesPickChannel: '选择一个云端频道。',
    cloudMessagesLoading: '正在加载消息...',
    cloudMessagesEmpty: '还没有可见消息。',
    cloudMessagesRefresh: '刷新',
    cloudMessagesLoadMore: '加载更多',
    cloudMessagesLoadingMore: '正在加载...',
    cloudMessagesNoContent: '（空消息）',
    cloudParticipantsTitle: '成员',
    cloudParticipantsEmpty: '暂无查看者',
    cloudHostOnline: '主机在线',
    ...
    bulk: {
      ...
      promptDialogTitle: count => `提示 ${count} 个会话`,
      promptDialogDesc: '向所有选中的会话发送同一条后续消息。',
      promptPlaceholder: '输入要发送到所选会话的消息…',
      promptSubmit: '发送提示',
      steerDialogTitle: count => `引导 ${count} 个会话`,
      steerDialogDesc: '用一条运行时指令引导所选会话。',
      steerPlaceholder: '输入运行时指令…',
      steerSubmit: '发送指令',
      clearSelection: '清除选择',
      deleteDialogTitle: count => `删除 ${count} 个会话？`,
      deleteDialogDesc: '这会从本机删除所选会话。此操作无法撤销。',
      deleteConfirm: '删除',
      archivedToast: count => `已归档 ${count} 个会话`,
      restoredToast: count => `已恢复 ${count} 个会话`,
      deletedToast: count => `已删除 ${count} 个会话`,
      archiveFailed: count => `无法归档 ${count} 个会话`,
      restoreFailed: count => `无法恢复 ${count} 个会话`,
      deleteFailed: count => `无法删除 ${count} 个会话`
    },
    row: {
      pin: '置顶',
      unpin: '取消置顶',
      ...
      inviteCloudTitle: '邀请到云端频道',
      inviteCloudDesc: '为这个已分享的聊天创建只读邀请。',
      inviteEmailPlaceholder: 'name@example.com',
      inviteCreate: '创建邀请',
      cloudMembersTitle: '云端成员',
      cloudMembersDesc: '当前可访问这个已分享聊天的账号。',
      ...
      deleteCloudTitle: '删除云端频道？',
      deleteCloudDesc: '本地聊天会保留，但云端历史、邀请、成员和实时访问将被永久移除。',
      deleteCloudConfirm: '删除云端频道',
      deleteCloudDeleting: '正在删除...',
  ...
  composer: {
    message: '消息',
    editQueued: '编辑队列中的消息',
    sendQueuedNext: '下一个发送队列中的消息',
    sendQueuedNow: '立即发送队列中的消息',
    deleteQueued: '删除队列中的消息',
  ...
  updates: {
    ...
    rebuildTitle: '源代码已更改',
    rebuildBody: 'Hermes 源代码已在上次构建后更改。请重新构建以应用本地更改。',
    notNow: '暂不',
    applyStatus: {
      preparing: '正在更新后端…',
      pulling: '后端更新中…',
