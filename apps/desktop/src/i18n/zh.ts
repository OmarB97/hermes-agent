...
export const zh: Translations = {
  ...
  sidebar: {
    ...
    archiveAllDialogDesc: '归档未置顶的会话，并保留当前、置顶及正在运行的会话。',
    ...
    bulk: {
      ...
      promptedToast: count => `已提示 ${count} 个会话`,
      steeredToast: count => `已引导 ${count} 个会话`,
      haltedToast: count => `已停止 ${count} 个会话`,
      promptFailed: count => `无法提示 ${count} 个会话`,
      steerFailed: count => `无法引导 ${count} 个会话`,
      haltFailed: count => `无法停止 ${count} 个会话`
    },
    row: {
      pin: '置顶',
      unpin: '取消置顶',
