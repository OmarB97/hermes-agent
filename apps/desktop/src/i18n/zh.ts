...
export const zh: Translations = {
  ...
  sidebar: {
    ...
    attention: {
      ...
      kindSecret: '密钥',
      kindSudo: 'Sudo',
      target: label => `给 ${label}`,
      targetAnyMember: '任意成员',
      targetOriginator: '发起者',
      targetOwnerAdmin: '所有者/管理员',
      targetPrincipal: '指定人员',
      targetRole: '指定角色',
      targetUnknown: '可响应的参与者',
      from: actor => `来自 ${actor}`,
      fromVia: (actor, via) => `来自 ${actor} 通过 ${via}`,
      via: via => `通过 ${via}`
    },
    cronJobs: '定时任务',
