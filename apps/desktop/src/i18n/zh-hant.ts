...
export const zhHant = defineLocale({
  ...
  sidebar: {
    ...
    archiveAllDialogDesc: '封存未釘選的工作階段，並保留目前、已釘選及執行中的工作階段。',
    archiveAllConfirm: '全部封存',
    archiveAllSubmitting: '封存中…',
    archiveAllChecked: count => `將檢查 ${count} 個可見工作階段。`,
    archiveAllSucceeded: count => `已封存 ${count} 個工作階段`,
    archiveAllFailed: '封存所有工作階段失敗',
    ...
    bulk: {
      ...
      restore: '恢復',
      delete: '刪除',
      promptCount: count => `提示 ${count} 個`,
      steerCount: count => `引導 ${count} 個`,
      haltCount: count => `停止 ${count} 個`,
      archiveCount: count => `封存 ${count} 個`,
      restoreCount: count => `恢復 ${count} 個`,
      deleteCount: count => `刪除 ${count} 個`,
      promptDialogTitle: count => `提示 ${count} 個工作階段`,
      promptDialogDesc: '向所有選取的工作階段傳送同一則訊息。',
      promptPlaceholder: '要傳送的訊息…',
      promptSubmit: '傳送提示',
      steerDialogTitle: count => `引導 ${count} 個工作階段`,
      steerDialogDesc: '向執行中的回合傳送同一則引導。',
      steerPlaceholder: '引導備註…',
      steerSubmit: '引導',
      clearSelection: '清除選取',
      deleteDialogTitle: count => `刪除 ${count} 個工作階段？`,
      deleteDialogDesc: '刪除的工作階段會永久移除。此操作無法復原。',
      deleteConfirm: '刪除',
      archivedToast: count => `已封存 ${count} 個工作階段`,
      restoredToast: count => `已恢復 ${count} 個工作階段`,
      deletedToast: count => `已刪除 ${count} 個工作階段`,
      archiveFailed: count => `無法封存 ${count} 個工作階段`,
      restoreFailed: count => `無法恢復 ${count} 個工作階段`,
      deleteFailed: count => `無法刪除 ${count} 個工作階段`,
      promptedToast: count => `已提示 ${count} 個工作階段`,
      steeredToast: count => `已引導 ${count} 個工作階段`,
      haltedToast: count => `已停止 ${count} 個工作階段`,
      promptFailed: count => `無法提示 ${count} 個工作階段`,
      steerFailed: count => `無法引導 ${count} 個工作階段`,
      haltFailed: count => `無法停止 ${count} 個工作階段`
    },
    row: {
      pin: '釘選',
      unpin: '取消釘選',
