...
export const zhHant = defineLocale({
  ...
  sidebar: {
    ...
    archiveAllTitle: '封存全部工作階段',
    archiveAllAria: '封存所有未釘選工作階段',
    archiveAllDialogTitle: '封存全部工作階段',
    archiveAllDialogDesc: '從側邊欄封存未釘選工作階段。已釘選、目前聊天和執行中的工作階段會保持可見。',
    archiveAllConfirm: '全部封存',
    archiveAllCancel: '取消',
    archiveAllSubmitting: '正在封存...',
    ...
    row: {
      ...
      cloudMembersPermission: permission =>
        ({ admin: '管理員', post: '可發言', read: '唯讀' })[permission] || permission,
