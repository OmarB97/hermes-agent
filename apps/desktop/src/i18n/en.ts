...
export const en: Translations = {
  ...
  sidebar: {
    ...
    attention: {
      ...
      kindClarify: 'Question',
      kindSecret: 'Secret',
      kindSudo: 'Sudo',
      target: label => `For ${label}`,
      targetAnyMember: 'any member',
      targetOriginator: 'originator',
      targetOwnerAdmin: 'owner/admin',
      targetPrincipal: 'selected person',
      targetRole: 'selected role',
      targetUnknown: 'eligible participant',
      from: actor => `From ${actor}`,
      fromVia: (actor, via) => `From ${actor} via ${via}`,
      via: via => `Via ${via}`
    },
    cronJobs: 'Cron jobs',
