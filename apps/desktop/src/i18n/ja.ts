...
export const ja = defineLocale({
  ...
  sidebar: {
    ...
    archiveAllDialogDesc: '固定中のチャット、現在のチャット、実行中のセッションを残してアーカイブします。',
    archiveAllConfirm: 'すべてアーカイブ',
    archiveAllSubmitting: 'アーカイブ中…',
    archiveAllChecked: count => `表示中の ${count} 件のセッションが対象になります。`,
    archiveAllSucceeded: count => `${count} 件のセッションをアーカイブしました`,
    archiveAllFailed: '一括アーカイブに失敗しました',
    ...
    bulk: {
      ...
      promptedToast: count => `${count} 件のセッションにプロンプトを送信しました`,
      steeredToast: count => `${count} 件のセッションに指示しました`,
      haltedToast: count => `${count} 件のセッションを停止しました`,
      promptFailed: count => `${count} 件のセッションにプロンプトを送信できませんでした`,
      steerFailed: count => `${count} 件のセッションに指示できませんでした`,
