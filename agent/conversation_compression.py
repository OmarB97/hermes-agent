...
def compress_context(
    ...
    *,
    ...
    # without recomputing it from cumulative deltas. Best-effort;
    # never block the agent loop on a state.db hiccup.
    if agent._session_db and agent.session_id:
        try:
            agent._session_db.set_compression_count(agent.session_id, _cc)
        except Exception:
            pass
