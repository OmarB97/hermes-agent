...
class TestFallbackPolicyValidation:
    """Fork (#269): fallback_policy is an explicit, validated enum.

    Upstream v0.20 pruned the surrounding fallback_model shape tests; these
    two pin the fork-only policy key, so they keep their own class.
    """
