...
class TestProfiles:
    ...
    def test_skill_pruning_scoped_to_coding_posture(self, tmp_path):
        # Fork feature kept alongside upstream's demotion: the coding posture
        # prunes clearly-non-coding categories outright; coding-adjacent ones
        # stay visible (deny-list semantics).
        _git_init(tmp_path)
