...
def test_codex_app_server_compaction_heartbeat_refreshes_activity_while_waiting():
    ...
    # Fork (#274): compaction starts a new context epoch but does not fabricate
    # a new successful provider snapshot. Preserve the last real completion
    # count until the next response supplies a replacement.
